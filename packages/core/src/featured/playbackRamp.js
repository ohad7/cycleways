...
export const PLAYBACK_BEHAVIOR_LEGACY = "legacy";
export const PLAYBACK_BEHAVIOR_NONE = "none";
export const PLAYBACK_BEHAVIORS = [
  PLAYBACK_BEHAVIOR_LEGACY,
  PLAYBACK_BEHAVIOR_NONE,
];

export function normalizePlaybackBehavior(value) {
  return PLAYBACK_BEHAVIORS.includes(value)
    ? value
    : PLAYBACK_BEHAVIOR_LEGACY;
}
...
export function computePlaybackRate({
  ...
  nearPoi,
  rampDone,
  playbackBehavior = PLAYBACK_BEHAVIOR_LEGACY,
}) {
  if (normalizePlaybackBehavior(playbackBehavior) === PLAYBACK_BEHAVIOR_NONE) {
    return 1;
  }
