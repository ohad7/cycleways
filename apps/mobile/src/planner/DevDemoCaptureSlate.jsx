...
export default function DevDemoCaptureSlate({ phase, error }) {
  ...
  if (phase === "sync-flash") {
    // Mapbox owns a native surface that can appear above ordinary React
    // siblings. A Modal gets its own top-level presentation, guaranteeing the
    // synchronization color reaches the Simulator recording.
    return (
...
const styles = StyleSheet.create({
  ...
  flash: { flex: 1, backgroundColor: "#d8ff00" },
