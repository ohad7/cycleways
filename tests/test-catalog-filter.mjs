...
const catalog = [
  { slug: "a", distanceKm: 5,  elevationGainM: 50,  regionId: "hula-valley", passesNear: ["beit-hillel"], startPlaceIds: ["beit-hillel"], routeShape: { type: "circular" }, difficulty: "easy",     style: "family",      qualityScore: 4.5 },
  { slug: "b", distanceKm: 15, elevationGainM: 200, regionId: "hula-valley", passesNear: ["dafna"],       startPlaceIds: ["dafna"],       routeShape: { type: "circular" }, difficulty: "moderate", style: "scenic",      qualityScore: 4.2 },
  { slug: "c", distanceKm: 30, elevationGainM: 700, regionId: "north-golan", passesNear: ["banias"],      startPlaceIds: ["dafna"],       routeShape: { type: "one_way" }, difficulty: "hard",     style: "sporty",      qualityScore: 3.8 },
  { slug: "d", distanceKm: 8,  elevationGainM: 30,  regionId: "hula-valley", passesNear: ["beit-hillel"], routeShape: { type: "circular" }, difficulty: "easy",     style: "scenic",      qualityScore: 3.5 },
];
